...
#include "cpu_6502/instruction_functors.hpp"
#include "cpu_6502/instruction_set.hpp"
#include "cpu_6502/memory_addressing.hpp"
...
InstructionHandlerArray GenInstructionHandlerArray(InstructionSet instruction_set) {
    ...
    using namespace emu::cpu6502::instructions;
...
Cpu6502::Cpu6502(InstructionSet instruction_set) : instruction_handlers(GetInstructionHandlerArray(instruction_set)) {
}

const InstructionHandlerArray &Cpu6502::GetInstructionHandlerArray(InstructionSet instruction_set) {
