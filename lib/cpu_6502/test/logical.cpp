...
std::vector<LogicalTestArg> GetANDTestCases() {
    ...
    return {
        ...
        {INS_AND_IM, AddressMode::IM, 2_u8, 2_u8, AND},
        // Zero Page     AND $44       $25  2   3
        {INS_AND_ZP, AddressMode::ZP, 2_u8, 3_u8, AND},
        // Zero Page,X   AND $44,X     $35  2   4
        {INS_AND_ZPX, AddressMode::ZPX, 2_u8, 4_u8, AND},
        // Absolute      AND $4400     $2D  3   4
        {INS_AND_ABS, AddressMode::ABS, 3_u8, 4_u8, AND},
        // Absolute,X    AND $4400,X   $3D  3   4+
        {INS_AND_ABSX, AddressMode::ABSX, 3_u8, 4_u8, AND},
        // Absolute,Y    AND $4400,Y   $39  3   4+
        {INS_AND_ABSY, AddressMode::ABSY, 3_u8, 4_u8, AND},
        // Indirect,X    AND ($44,X)   $21  2   6
        {INS_AND_INDX, AddressMode::INDX, 2_u8, 6_u8, AND},
        // Indirect,Y    AND ($44),Y   $31  2   5+
        {INS_AND_INDY, AddressMode::INDY, 2_u8, 5_u8, AND},
    };
}
...
std::vector<LogicalTestArg> GetEORTestCases() {
    ...
    return {
        ...
        {INS_EOR_IM, AddressMode::IM, 2_u8, 2_u8, EOR},
        // Zero Page     EOR $44       $45  2   3
        {INS_EOR_ZP, AddressMode::ZP, 2_u8, 3_u8, EOR},
        // Zero Page,X   EOR $44,X     $55  2   4
        {INS_EOR_ZPX, AddressMode::ZPX, 2_u8, 4_u8, EOR},
        // Absolute      EOR $4400     $4D  3   4
        {INS_EOR_ABS, AddressMode::ABS, 3_u8, 4_u8, EOR},
        // Absolute,X    EOR $4400,X   $5D  3   4+
        {INS_EOR_ABSX, AddressMode::ABSX, 3_u8, 4_u8, EOR},
        // Absolute,Y    EOR $4400,Y   $59  3   4+
        {INS_EOR_ABSY, AddressMode::ABSY, 3_u8, 4_u8, EOR},
        // Indirect,X    EOR ($44,X)   $41  2   6
        {INS_EOR_INDX, AddressMode::INDX, 2_u8, 6_u8, EOR},
        // Indirect,Y    EOR ($44),Y   $51  2   5+
        {INS_EOR_INDY, AddressMode::INDY, 2_u8, 5_u8, EOR},
    };
}
...
std::vector<LogicalTestArg> GetORATestCases() {
    ...
    return {
        ...
        {INS_ORA_IM, AddressMode::IM, 2_u8, 2_u8, ORA},
        // Zero Page     ORA $44       $05  2   3
        {INS_ORA_ZP, AddressMode::ZP, 2_u8, 3_u8, ORA},
        // Zero Page,X   ORA $44,X     $15  2   4
        {INS_ORA_ZPX, AddressMode::ZPX, 2_u8, 4_u8, ORA},
        // Absolute      ORA $4400     $0D  3   4
        {INS_ORA_ABS, AddressMode::ABS, 3_u8, 4_u8, ORA},
        // Absolute,X    ORA $4400,X   $1D  3   4+
        {INS_ORA_ABSX, AddressMode::ABSX, 3_u8, 4_u8, ORA},
        // Absolute,Y    ORA $4400,Y   $19  3   4+
        {INS_ORA_ABSY, AddressMode::ABSY, 3_u8, 4_u8, ORA},
        // Indirect,X    ORA ($44,X)   $01  2   6
        {INS_ORA_INDX, AddressMode::INDX, 2_u8, 6_u8, ORA},
        // Indirect,Y    ORA ($44),Y   $11  2   5+
        {INS_ORA_INDY, AddressMode::INDY, 2_u8, 5_u8, ORA},
    };
}
...
std::vector<LogicalTestArg> GetBITTestCases() {
    ...
    return {
        ...
        {INS_BIT_ZP, AddressMode::ZP, 2_u8, 3_u8, AND},
        // Absolute      BIT $4400     $2C  3   4
        {INS_BIT_ABS, AddressMode::ABS, 3_u8, 4_u8, AND},
    };
}
