...
using OpFunctor = std::function<uint16_t(uint8_t, uint8_t, uint8_t)>;
using ArithmeticTestArg = std::tuple<Opcode, const char *, AddressMode, uint8_t, uint8_t, OpFunctor>;

class ArithmeticTest : public BaseTest, public ::testing::WithParamInterface<ArithmeticTestArg> {
public:
...
std::vector<ArithmeticTestArg> GetTestCases() {
    ...
    auto ADD = [](uint8_t a, uint8_t b, uint8_t c) -> uint16_t { return a + b + c; };
    auto SBC = [](uint8_t a, uint8_t b, uint8_t c) -> uint16_t { return a + c - b; };
    // TODO: + add 1 cycle if page boundary crossed
    return {
        // MODE           SYNTAX       HEX LEN TIM
        // Immediate     ADC #$44      $69  2   2
        {INS_ADC, "ADC", AddressMode::IM, 2_u8, 2_u8, ADD},
        // Absolute      ADC $4400     $6D  3   4
        {INS_ADC_ABS, "ADC", AddressMode::ABS, 3_u8, 4_u8, ADD},
        // Zero Page     ADC $44       $65  2   3
        {INS_ADC_ZP, "ADC", AddressMode::ZP, 2_u8, 3_u8, ADD},
        // Zero Page,X   ADC $44,X     $75  2   4
        {INS_ADC_ZPX, "ADC", AddressMode::ZPX, 2_u8, 4_u8, ADD},
        // Absolute,X    ADC $4400,X   $7D  3   4+
        {INS_ADC_ABSX, "ADC", AddressMode::ABSX, 3_u8, 4_u8, ADD},
        // Absolute,Y    ADC $4400,Y   $79  3   4+
        {INS_ADC_ABSY, "ADC", AddressMode::ABSY, 3_u8, 4_u8, ADD},
        // Indirect,X    ADC ($44,X)   $61  2   6
        {INS_ADC_INDX, "ADC", AddressMode::INDX, 2_u8, 6_u8, ADD},
        // Indirect,Y    ADC ($44),Y   $71  2   5+
        {INS_ADC_INDY, "ADC", AddressMode::INDY, 2_u8, 5_u8, ADD},
        // Immediate     SBC #$44      $E9  2   2
        {INS_SBC, "SBC", AddressMode::IM, 2_u8, 2_u8, SBC},
        // Absolute      SBC $4400     $ED  3   4
        {INS_SBC_ABS, "SBC", AddressMode::ABS, 3_u8, 4_u8, SBC},
        // Zero Page     SBC $44       $E5  2   3
        {INS_SBC_ZP, "SBC", AddressMode::ZP, 2_u8, 3_u8, SBC},
        // Zero Page,X   SBC $44,X     $F5  2   4
        {INS_SBC_ZPX, "SBC", AddressMode::ZPX, 2_u8, 4_u8, SBC},
        // Absolute,X    SBC $4400,X   $FD  3   4+
        {INS_SBC_ABSX, "SBC", AddressMode::ABSX, 3_u8, 4_u8, SBC},
        // Absolute,Y    SBC $4400,Y   $F9  3   4+
        {INS_SBC_ABSY, "SBC", AddressMode::ABSY, 3_u8, 4_u8, SBC},
        // Indirect,X    SBC ($44,X)   $E1  2   6
        {INS_SBC_INDX, "SBC", AddressMode::INDX, 2_u8, 6_u8, SBC},
        // Indirect,Y    SBC ($44),Y   $F1  2   5+
        {INS_SBC_INDY, "SBC", AddressMode::INDY, 2_u8, 5_u8, SBC},
    };
}
