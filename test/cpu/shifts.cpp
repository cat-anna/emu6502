...
std::vector<LogicalTestArg> GetTestCases() {
    ...
    return {
        ...
        {INS_ROL, "ROL", AddressMode::ACC, 1, 2, ROL},
        // Zero Page     ROL $44       $26  2   5
        {INS_ROL_ZP, "ROL", AddressMode::ZP, 2, 5, ROL},
        // Zero Page,X   ROL $44,X     $36  2   6
        {INS_ROL_ZPX, "ROL", AddressMode::ZPX, 2, 6, ROL},
        // Absolute      ROL $4400     $2E  3   6
        {INS_ROL_ABS, "ROL", AddressMode::ABS, 3, 6, ROL},
        // Absolute,X    ROL $4400,X   $3E  3   7
        {INS_ROL_ABSX, "ROL", AddressMode::ABSX, 3, 7, ROL},
        // Accumulator   ROR A         $6A  1   2
        {INS_ROR, "ROR", AddressMode::ACC, 1, 2, ROR},
        // Zero Page     ROR $44       $66  2   5
        {INS_ROR_ZP, "ROR", AddressMode::ZP, 2, 5, ROR},
        // Zero Page,X   ROR $44,X     $76  2   6
        {INS_ROR_ZPX, "ROR", AddressMode::ZPX, 2, 6, ROR},
        // Absolute      ROR $4400     $6E  3   6
        {INS_ROR_ABS, "ROR", AddressMode::ABS, 3, 6, ROR},
        // Absolute,X    ROR $4400,X   $7E  3   7
        {INS_ROR_ABSX, "ROR", AddressMode::ABSX, 3, 7, ROR},
        // Accumulator   ASL A         $0A  1   2
        {INS_ASL, "ASL", AddressMode::ACC, 1, 2, ASL},
        // Zero Page     ASL $44       $06  2   5
        {INS_ASL_ZP, "ASL", AddressMode::ZP, 2, 5, ASL},
        // Zero Page,X   ASL $44,X     $16  2   6
        {INS_ASL_ZPX, "ASL", AddressMode::ZPX, 2, 6, ASL},
        // Absolute      ASL $4400     $0E  3   6
        {INS_ASL_ABS, "ASL", AddressMode::ABS, 3, 6, ASL},
        // Absolute,X    ASL $4400,X   $1E  3   7
        {INS_ASL_ABSX, "ASL", AddressMode::ABSX, 3, 7, ASL},
        // Accumulator   LSR A         $4A  1   2
        {INS_LSR, "LSR", AddressMode::ACC, 1, 2, LSR},
        // Zero Page     LSR $44       $46  2   5
        {INS_LSR_ZP, "LSR", AddressMode::ZP, 2, 5, LSR},
        // Zero Page,X   LSR $44,X     $56  2   6
        {INS_LSR_ZPX, "LSR", AddressMode::ZPX, 2, 6, LSR},
        // Absolute      LSR $4400     $4E  3   6
        {INS_LSR_ABS, "LSR", AddressMode::ABS, 3, 6, LSR},
        // Absolute,X    LSR $4400,X   $5E  3   7
        {INS_LSR_ABSX, "LSR", AddressMode::ABSX, 3, 7, LSR},
    };
}
