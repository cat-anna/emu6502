...
class Compiler6502 {
public:
    Compiler6502(InstructionSet cpu_instruction_set = InstructionSet::Default, bool verbose = true);
...
std::unique_ptr<Program> CompileString(std::string text, InstructionSet cpu_instruction_set = InstructionSet::Default);
std::unique_ptr<Program> CompileFile(const std::string &file,
